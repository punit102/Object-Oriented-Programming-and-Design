...
public class ReverseAlphabeticalComparatorTest {
	...
	// This is ReverseAlphabeticalComparatorTest compare method testing in which it shows get children elements comes in reverse order
	@Test
	public void testReverseCompareExecute() {
		...
		shell_command.sortCommand("reverse");
