...
public class CpTest {
	...
	// This is cp Command execute() testing --- test its given void method result

	@Test
	public void testCpExecute() {
		...
		shell_command.cpCommand(d.toString(), system);
