...
public class HistoryTest {
	...
	// This is History Command execute() testing --- test its given void method result
	
	@Test
	public void testHistoryExecute() {
		...
		shell_command.dirCommand(home.toString());
		FileSystem.getInstance().setCurrent(home);
		shell_command.chownCommand("Ranu");
		FileSystem.getInstance().setCurrent(rootDir);
		
		shell_command.dirCommand(home.toString());
		
		
		shell_command.historyCommand();
		

		String expected = "Current Working Directory in Pwd Command: root:Directory\nYou move to the this Directory :\nhome:Directory   root:Directory   Punit   30\nYou move to the this Directory :\nhome:Directory   root:Directory   Ranu   30\npwd\ndir home:Directory\nchown Ranu\ndir home:Directory\nHistory\n";
